...
int detect(char *model_path, char *image_path, char *save_image_path)
{
    ...
    GetResultRectYolov10 PostProcess;
...
{
    char model_path[256] = "/home/firefly/zhangqian/rknn/rknpu2_1.4.0/examples/rknn_yolov10_demo_open/model/RK3588/yolov10n_zq.rknn";
